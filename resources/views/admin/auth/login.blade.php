            ...
            <div class="collapse navbar-collapse" id="navigation">
              ...
              <ul class="navbar-nav d-lg-flex d-none">
                <li class="nav-item d-flex align-items-center">
                  <a class="btn btn-outline-primary btn-sm mb-0 me-2" href="{{route('admin.register')}}">Creer Compte</a>
                </li>
                <li class="nav-item">
            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                <form role="form" class="text-start" method="POST" action="{{ route('admin.login') }}">
                  ...
                  <a href="{{ route('admin.password.request') }}" class="mt-4 text-sm d-block text-end"> mot de passe oublié?</a>
