                        ...
                        <div class="collapse navbar-collapse" id="navigation">
                            ...
                            <ul class="navbar-nav d-lg-flex d-none">
                                <li class="nav-item d-flex align-items-center">
                                    <a class="btn btn-outline-primary btn-sm mb-0 me-2" href="{{route('admin.login')}}">Login</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="card-body">
                                <form role="form" method="POST" action="{{ route('admin.register') }}">
                                    ...
                                    <p class="mt-4 text-sm text-center">
                                        Deja un compte?
                                        <a href="{{route('admin.login')}}" class="text-primary text-gradient font-weight-bold">login</a>
                                    </p>
                                </form>
                            </div>
                        </div>
