                ...
                <div class="p-0 overflow-x-auto">
                    <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                        <thead class="align-bottom bg-gray-100">
                            <tr>
                                <th class="px-6 py-3 font-bold text-left text-xs text-slate-400 uppercase">Moy.paiement</th>
                                <th class="px-6 py-3 font-bold text-left text-xs text-slate-400 uppercase">ID-PAIEMENT</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="px-6 py-3 text-sm">{{ $payment->methode_paiement }}</td>
                                <td class="px-6 py-3 text-sm">{{ $payment->id_transaction }}</td>
                                ...
                                <td class="px-6 py-3 text-sm">
                                    <!--<a href="{{ route('admin.payments.show', $payment->id) }}" class="text-blue-500 hover:underline"><i class="fas fa-image"></i></a>-->
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
