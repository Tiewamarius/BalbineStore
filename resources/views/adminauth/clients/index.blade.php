                    ...
                    <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                        <thead class="align-bottom bg-gray-100">
                            <tr>
                                ...
                                <th class="px-6 py-3 font-bold text-left text-xs text-slate-400 uppercase">Sejour</th>
                            ...
                            <tr>
                                <td>
                                    <div class="flex px-2 py-1">
                                        <div>
                                            <img src="{{ asset('storage/' .$client->profile_picture) }}" class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl" alt="user1" />
                                        </div>
                                        <div class="flex flex-col justify-center">
                                            <h6 class="mb-0 text-sm leading-normal">{{ $client->name }}</h6>
                                            <p class="mb-0 text-xs leading-tight text-slate-400">{{ $client->email }}</p>
                                        </div>
                                    </div>
                                </td>
                                <td></td>
